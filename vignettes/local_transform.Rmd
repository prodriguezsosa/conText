...
Given our "local" embeddings, we next compute the feature co-occurrence matrix for our corpus. We do this using `quanteda`'s `fcm` function. Depending on the size of your corpus, this can take several minutes (a little over 10 mins on 2019 mac book pro for this corpus).
