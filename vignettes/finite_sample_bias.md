...
As one might expect: the smaller the sample—for any of the slices of the
...
Figure 1 plots our results. The plots on the left capture results for
...
**Note:** The current version of `conText` continues to allow for
